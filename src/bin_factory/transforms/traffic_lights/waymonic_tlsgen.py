...
from src.bin_factory.transforms.traffic_lights.utils.intersection import ApproachingLane, InJunctionLane, VehicleState
from src.bin_factory.transforms.traffic_lights.utils.waymo import (
    LaneCenter,
    WaymonicTLS,
)
                    ...
                    for conn in lane.injunction_lanes:
                        ...
                        if traffic_light_id not in dynamic_map_states:
                            dynamic_map_states[traffic_light_id] = {
                                ...
                                "states": [None] * self.scenario["scenario_length"],
