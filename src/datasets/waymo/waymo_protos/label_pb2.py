...
from src.datasets.waymo.waymo_protos import keypoint_pb2 as scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_keypoint__pb2
